...
class ChatroomConsumer(WebsocketConsumer):
    def connect(self):
        ...
        # Add and update user online list
        if self.user.is_authenticated and self.user not in self.chatroom.user_online.all():
    ...
    def disconnect(self, close_code):
        ...
        if self.user.is_authenticated and self.user in self.chatroom.user_online.all():
    ...
    def receive(self, text_data):
        ...
        if not body or not self.user.is_authenticated:
            return
